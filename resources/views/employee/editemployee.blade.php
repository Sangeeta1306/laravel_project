     ...
     <div class="container ">
        <div class="col-md-8 mx-auto" style="padding-left:400px; padding-top:100px;">
            ...
            <form action="{{route('updateemployee')}}" method="POST" enctype="multipart/form-data">        
                ...
                <input type="text" name="fname" class="au-input au-input--full mb-2" value="{{ $data['fname'] }}">
                <label class="form-level fw-bold mb-2">Employee last Name</label class="form-level fw-bold">
                <input type="text" name="lname" class="au-input au-input--full mb-2" value="{{ $data['lname'] }}">
                ...
                <input type="text" name="contact" class=" au-input au-input--full mb-2"      value="{{ $data['phone'] }}">                  
